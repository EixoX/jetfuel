...
public class XmlAspectMember extends AspectField {
	...
	private XmlAdapter<?> createXmlAdapterForCdata(String xmlName) {
	...
	private XmlAdapter<?> createXmlAdapterForElement(String xmlName) {
		// Simple elements?
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private XmlAdapter<?> createXmlAdapterForText(String xmlName) {
	...
	private XmlAdapter<?> createXmlAdapter(String xmlName, Xml annotation) {
		...
		case CDATA:
			return createXmlAdapterForCdata(xmlName);
		case ELEMENT:
			return createXmlAdapterForElement(xmlName);
		case TEXT:
			return createXmlAdapterForText(xmlName);
		default:
